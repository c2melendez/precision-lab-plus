...
def normalize_unicode(text: str) -> str:
    ...
    # átomos simples o un único grupo parentizado.
...
def _validate_unknown_function_calls(text: str) -> None:
    """Reject unknown multi-letter calls before implicit multiplication rewrites them."""
...
def _try_parse_finite_aggregate(text: str) -> Optional[sympy.Basic]:
    """Parse finite calculator sum/product through a bounded structured route."""
